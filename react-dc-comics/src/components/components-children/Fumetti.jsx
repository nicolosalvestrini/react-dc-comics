const comics = [
  ...
  },
  {
    ...
    thumb: "https://www.fumetto-online.it/ew/ew_albi/images/PLAY%20PRESS/BATMAN056.jpg",
    price: "$3.99",
    series: "Batman",
...
export default function FumettiCards() {
    return (
            <section className="row">
            {comics.map((comic) => {
                return (
                    <div key={comic.id} className="col-2">
                        <img src={comic.thumb} alt={comic.title} className="card-img-top cover-img" />
                        <div className="">
